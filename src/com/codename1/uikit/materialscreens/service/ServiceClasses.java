...
import com.codename1.uikit.materialscreens.ClassForm;
...
public class ServiceClasses {
    ...
    //*****************************
    public ServiceClasses(Integer id_class, String fullName, String birthday, String email, Integer id_user, Integer idPupil) {
    ...
    public void ServiceClassesR(Integer id_class, Integer id) {
        ...
        conx.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    System.out.println(+classe.getId() + classe.getNameClass() + classe.getSession() + "aaaaaaaaaaaaaa");
                    new ClassForm(classe.getId(), classe.getNameClass(), classe.getSession(), id).show();
